    ...
    <div className="productonsale flex border-t-4 border-b-4 border-emerald-200 flex-col items-center rounded-xl shadow-lg hover:shadow-2xl p-4 transition ease-in-out duration-200">
      <div className="flex flex-row items-center justify-between">
        ...
        <div className="italic text-right">
            <a className="block underline underline-offset-1 cursor-pointer">FILLERS</a>
            <a className="block underline underline-offset-1 cursor-pointer">SHAMPOO</a>
            <a className="block underline underline-offset-1 cursor-pointer">HAIR GROWTH SERUMS</a>
            <a className="block underline underline-offset-1 cursor-pointer">DARK CIRCLE SOLUTIONS </a>
        </div>
      </div>
      <div>
        <img className="h-56" src="./assets/images/sale/ProductOnSalePic.png" alt="" />
      </div>
      <div>
        <img className="" src="./assets/images/sale/brands.png" alt="" />
      </div>
      <div>
