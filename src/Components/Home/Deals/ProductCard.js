    ...
    <div class="max-w-sm bg-white rounded-lg shadow-md mx-4">
      ...
      <div class="px-5 pb-5">
        ...
        <div class="flex justify-between items-center">
          ...
          <a
            href="#"
            class="text-white bg-[#50B291] hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
          >
            Add to cart
          </a>
        </div>
