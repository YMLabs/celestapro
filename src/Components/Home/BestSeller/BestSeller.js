    ...
    <section className="deals-of-the-day p-12 flex-col flex lg:flex-row items-center">
      <div className="py-8 lg:w-1/5 w-full flex justify-center flex-col">
        ...
        <button
          ...
          class="inline-block px-6 py-2.5 mx-auto bg-[#50B291] text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-emerald-600 hover:shadow-lg focus:bg-[#50B291] focus:shadow-lg focus:outline-none focus:ring-0 active:bg-teal-800 active:shadow-lg transition duration-150 ease-in-out"
        >
          See All
        </button>
      </div>
