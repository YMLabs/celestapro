    ...
    <Disclosure as="nav" className="">
      {({ open }) => (
        <>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="relative w-2/5">
                      ...
                      <input
                        type="search"
                        id="default-search"
                        className="block p-4 pl-10 w-full text-sm text-gray-100 bg-[#50B291] rounded-lg border border-gray-300 focus:outline-none font-semibold placeholder-white"
                        placeholder="Search ..."
                        required
                      />
                      <button
                        type="submit"
                        className=" absolute right-2.5 bottom-2.5 bg-white text-[#50B291] hover:bg-gray-200 focus:ring-emerald-100 font-medium rounded-lg text-sm px-4 py-2 border-transparent focus:border-transparent focus:ring-0"
                      >
                        Search
                      </button>
                    </div>
          ...
          <Disclosure.Panel className="md:hidden border-2 rounded-md mx-2 mb-4">
